...
-- Limpieza de vistas y tablas previas con tipos incompatibles si existen
DROP VIEW IF EXISTS active_loans CASCADE;
DROP TABLE IF EXISTS revocations CASCADE;
DROP TABLE IF EXISTS revocation_actions CASCADE;
DROP TABLE IF EXISTS audit_log CASCADE;
DROP TABLE IF EXISTS invoices CASCADE;
DROP TABLE IF EXISTS notifications CASCADE;
DROP TABLE IF EXISTS loan_comments CASCADE;
DROP TABLE IF EXISTS loan_simulations CASCADE;
